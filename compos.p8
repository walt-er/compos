...
--  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'
--
--  ~/picotool-master/p8tool build compos.p8 --lua=compos.lua --lua-minify

-- =======================================================
-- generic globals
-- =======================================================

local window_w, window_h, tile, cam = 128, 128, 8, {};
...
local logs, permalogs, show_colliders, log_states, log_statuses = {}, {}, false, false, false;
